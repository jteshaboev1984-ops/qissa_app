...
'story.read_mode':'O‘qish','story.listen_mode':'Tinglash','story.listen_placeholder':'Bu yerda epizod muqovasi va audio boshqaruvi ko‘rinadi.','story.audio_controls':'Audio boshqaruvi','story.make_choice':'Qahramon nimani tanlaydi?','story.words_preview':'Hikoyadagi so‘zlar (ixtiyoriy)','story.choice_confirmation':'Tanlov qabul qilindi.','story.world_remembers':'Hikoya olami tanlovingizni eslab qoldi.','story.continue_next_episode':'Keyingi qismga o‘tish','story.next_episode_hint':'Keyingi qism shu tanlovdan boshlanadi.','home.world_remembers':'Hikoya olami tanlovingizni eslaydi.','home.last_episode_summary':'Oxirgi qism yakuni','home.reset_story':'Hikoyani qayta boshlash','home.restart_story':'Istasangiz, hikoyani boshidan boshlashingiz mumkin' }
...
'story.read_mode':'Оқу','story.listen_mode':'Тыңдау','story.listen_placeholder':'Мұнда эпизод мұқабасы мен аудио басқару көрсетіледі.','story.audio_controls':'Аудио басқару','story.make_choice':'Кейіпкер нені таңдайды?','story.words_preview':'Оқиға сөздері (қалау бойынша)','story.choice_confirmation':'Таңдау қабылданды.','story.world_remembers':'Оқиға әлемі таңдауыңызды ұмытпайды.','story.continue_next_episode':'Келесі бөлімге өту','story.next_episode_hint':'Келесі бөлім осы таңдаудан басталады.','home.world_remembers':'Оқиға әлемі таңдауыңызды есте сақтайды.','home.last_episode_summary':'Соңғы бөлімнің қорытындысы','home.reset_story':'Оқиғаны қайта бастау','home.restart_story':'Қаласаңыз, оқиғаны басынан бастауға болады' }

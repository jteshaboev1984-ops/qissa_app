...
У {{HERO}} появилась идея: сначала всем вместе дойти до самой развилки. По дороге компания заметила лужу в форме луны, поваленную веточку и три блестящих жёлудя. Пух хотел положить один в карман, но промахнулся и уронил его себе в капюшон. Пока он пытался достать желудь, даже черепаха успела его обогнать.
...
Пух важно передал ей корзинку. Но в этот момент один орех всё-таки выскочил и покатился вниз по корню. Орех остановился у ботинка {{HERO}}, а белка решила, что на сегодня корзинке хватит приключений. Фонарик над корнями осветил дорожку к дуплу. Белка помахала всем хвостом и скрылась внутри. Через секунду из окна высунулась только её лапка, чтобы ещё раз помахать.
...
Чуть дальше был ручей. Здесь вода добавила своё «ш-ш-ш». Нура спела начало, Пух ответил, а последняя нота осталась за {{HERO}}. Светлячки летели над головами и мигали ровно в тот момент, когда наступала пауза.
...
Так Пух остался с компанией ещё на один кусочек пути. У большого камня песня вдруг стала тише: светлячки разлетелись в разные стороны. До {{HERO}} донеслось, как из травы отвечает один-единственный «пи». Маленький светлячок отстал от остальных и сел на мокрый лист.
...
На обратном пути никто уже не пел весь припев. У берёзы Нура напела две ноты. У ручья в ответ от {{HERO}} прозвучала ещё одна нота. Белкино «тук-тук» донеслось из далёкого окна. Этого хватало, чтобы вспомнить всю дорогу.
...
Eski to‘nka oldida Puf nihoyat xayrlashdi. U iniga qarab uch qadam yugurdi, keyin charchaganini eslab, oddiy yurishga o‘tdi. Nura jilmaydi. Yorug‘qo‘ng‘izlar maysa orasiga qo‘ndi, ariq qo‘shiqning o‘z qismini davom ettirdi, o‘rmon esa asta-sekin tungi tovushlar bilan qoldi. Uzoqdagi in eshigi yopildi. So‘ng faqat barglarning shitiri va suvning «sh-sh-sh»i eshitilib turdi.`,
  ...
  magic_garden: {
    ...
    episodeOne: {
      ru: `В Волшебном саду вечер начинался с одного и того же чуда: как только над фонтаном появлялась первая звезда, лунные цветы открывали серебряные лепестки. Для {{HERO}} их пробуждение было любимым вечерним чудом. Рядом ползла улитка Мирай, а на ручке маленькой лейки сидела птица Лило.
...
Лепесток сняли, и смех {{HERO}} смешался с щебетом Лило.
...
Вместе с {{HERO}} друзья прошли вдоль клумбы. Один бутон стоял у сухого камня. Другой повернулся к отражению звезды в воде. Третий едва заметно дрогнул, когда светлячок подлетел ближе к стеклу.
...
Лило засмеялась так звонко, что один закрытый цветок чуть-чуть качнулся. Это сразу заметили и {{HERO}}, и Мирай. Похоже, цветы реагировали на всё вокруг: на воду, свет, звук, даже на движение теней.
...
На самом маленьком цветке перед {{HERO}} блеснула тонкая серебряная полоска на бутоне. Она то появлялась, то исчезала. Будто цветок хотел открыться, но никак не решался.
...
У маленького бутона вся компания собралась рядом с {{HERO}}.
...
Lilo sanashni to‘xtatdi. Miroy mo‘ylovlarini ko‘tardi. Yorug‘qo‘ng‘izlar ham bir lahza dumaloq shaklga tizildi. Tanlov {{HERO}}da edi.`,
    ...
    choices: {
      'choice-a': {
        ...
        effect: {
          ru: `После выбора {{HERO}} сухие корни получили воду, и первый лунный цветок раскрыл серебряный лепесток.`,
          uz: `{{HERO}} quruq ildizlarga suv quydi va birinchi oy guli kumushrang gulbargini ochdi.`,
        },
        resolution: {
          ru: `Лейка оказалась в руках {{HERO}}, и вода полилась вокруг самого маленького бутона. Вода ушла под корни, а через секунду на стебле появилась блестящая капля. Она поднялась выше, словно маленькая бусинка, и бутон раскрыл один серебряный лепесток. Мирай захлопала усиками по раковине, а Лило объявила, что это был «цветочный привет». Теперь они пошли к следующему сухому месту.`,
...
Друзья пошли дальше вдоль клумбы. Вода из лейки {{HERO}} попадала только туда, где земля была сухой. Иногда цветок открывался сразу, иногда приходилось подождать. Один крошечный бутон вообще не двинулся. Мирай уже хотела проверить корни ещё раз, но Лило заметила, что на его лепестке лежит тяжёлая капля росы.

Пальцы {{HERO}} слегка задели соседний лист. Капля скатилась вниз. Бутон расправился и оказался ярко-голубым внутри.
...
Когда друзья подошли ближе, цветок чуть наклонился к {{HERO}}. Из его середины выкатилась круглая капля и плюхнулась в воду. По фонтану разошлись кольца, и в каждом на секунду отразилась звезда.
...
Последняя пригоршня воды из ладони {{HERO}} досталась маленькому сухому участку у дорожки. Там не было цветка, зато через минуту из земли показался тонкий зелёный росток.

— О, — сказала Лило. — Похоже, завтра нас кто-то удивит.

Никто не стал будить росток вопросами. Лейку оставили возле фонтана рядом с {{HERO}}. Лунные цветы один за другим начали складывать лепестки. Голубые точки становились всё бледнее, пока дорожка не превратилась в обычную полоску между клумбами.

Лило спрятала голову под крыло. Мирай зевнула так широко, как умеют зевать только улитки. Фонтан плеснул ещё раз. Перед уходом взгляд {{HERO}} задержался на маленьком зелёном ростке. Сад получил пожелание доброй ночи, а дорожка повела домой. За спиной серебряные лепестки закрылись окончательно, а на раковине Мирай осталась одна крошечная капля, похожая на звезду.`,
...
Lilo boshini qanoti ostiga oldi. Miroy katta esnadi. Favvora yana bir marta «plop» dedi. {{HERO}} yashil niholga qarab, bog‘ga xayrli tun tiladi va uyiga ketdi. Orqada kumush gulbarglar butunlay yopildi. Miroyning qobig‘ida esa tonggacha saqlanadigandek bitta kichkina tomchi yulduzcha bo‘lib yaltirab qoldi. Lilo qanoti ostidan bir marta ko‘z tashlab, yana uxlab qoldi.`,
      ...
      'choice-b': {
        ...
        effect: {
          ru: `После выбора {{HERO}} светлячки вылетели из чаши, и их танец помог лунным цветам повернуться к свету.`,
          uz: `{{HERO}} yorug‘qo‘ng‘izlarni uchirdi va ularning raqsi oy gullariga nur tomonga burilishga yordam berdi.`,
        },
        resolution: {
          ru: `Чаша оказалась возле закрытых цветов. Крышку открыли рядом с {{HERO}}. Светлячки вылетели по одному. Первый сделал круг, второй завис над дорожкой, третий сел Лило прямо на макушку. Птица замерла, боясь его спугнуть, и стала похожа на маленькую лампу. Цветок рядом повернулся к огоньку и раскрыл два лепестка. Тогда светлячки полетели дальше вдоль клумбы.`,
...
Мирай проползла по краю дорожки и оставила за собой тонкую блестящую линию. Светлячки заметили её и выстроились вдоль следа. Получилась целая светящаяся змейка. Светящаяся змейка повела {{HERO}} за собой, а лунные цветы по обе стороны стали открываться один за другим.

Один маленький бутон упорно смотрел в другую сторону. Светлячки кружили перед ним, но он не двигался. Причина оказалась прямо перед {{HERO}}: его стебелёк зацепился за сухую травинку.
...
На краю фонтана нашлось место и для {{HERO}}. Мирай спрятала голову в раковину, потом высунулась обратно, потому что забыла пожелать всем доброй ночи. Лило устроилась рядом и прикрыла глаза.
...
Сад снова стал тёмным, но теперь в темноте легко угадывались знакомые клумбы. Где-то под листом ещё раз смешно фыркнула Мирай. Лило, Мирай и лунные цветы получили от {{HERO}} пожелание доброй ночи. Пора было идти домой. Последний светлячок устроился на листе рядом с чашей, словно тоже нашёл себе кроватку, и больше в саду никто никуда не летел.`,
...
Oxirgi og‘onak yo‘l chetida {{HERO}}ga bir marta miltilladi. Favvora uning aksini bir lahza ushlab, keyin qorong‘iga qaytardi. Bog‘ yana qorong‘i bo‘ldi, ammo endi gulzorlarning qayerdaligi bilinib turardi. {{HERO}} Lilo, Miroy va oy gullariga xayrli tun tilab, uyiga ketdi. Kosaning yonidagi bitta yorug‘qo‘ng‘iz yaproq «yostiq» ustiga qo‘ndi va shu yerda qimirlamay qoldi. Bog‘ ham unga qo‘shilib dam olayotgandek edi.`,
  ...
  stars_and_space: {
    ...
    episodeOne: {
      ru: `Ночью станция «Люмен» была похожа на дом с очень большим круглым окном. За стеклом висели звёзды, а внутри горели только маленькие лампы у пола. У {{HERO}} и робота Пико было вечернее дело: подготовить место для ночной почты.
...
У окна оказались {{HERO}} и Пико. Далеко в темноте снова мигнула крошечная серебряная точка.
...
Звёздочку сняли со лба Пико и приклеили на край окна рядом с {{HERO}}. Пико достал ещё несколько. Можно было зажечь золотой фонарь у стекла, чтобы почтовая капсула увидела один яркий огонёк. А можно было сложить из светящихся звёздочек большую птицу, крыло которой показывало бы на «Люмен».
...
Пико услышал смех {{HERO}}. Потом оба посмотрели в окно. Почтовая капсула была уже немного ближе. Она летела сама и никуда не пропадала, просто не могла понять, какое из множества огоньков впереди — окно «Люмена».
...
На стекле перед {{HERO}} появились четыре звёздочки. Из них уже получалось маленькое крыло. Пико поставил рядом фонарь, и золотой круг лёг на стекло.
...
Перед {{HERO}} лежали золотой фонарь и россыпь звёздочек. Выбор оставался за {{HERO}}.`,
...
Рисунки заняли пустые рамки рядом с {{HERO}}. Пико хотел выбрать самый смешной, но долго не мог решить между котом и Луной. В конце концов он поставил их рядом.
...
Серебряная капсула снаружи мигнула один раз. Через стекло капсуле помахали {{HERO}} и Пико. Пико тоже помахал, но слишком широко и задел локтем пустую коробку. Коробка медленно перевернулась, а робот сделал вид, будто именно так и было задумано.
...
Пико выключил последнюю яркую лампу. На «Люмене» остался только ночной свет у пола и маленький золотой маяк у окна. Луна в полосатом шарфе получила последний взгляд от {{HERO}}. Потом {{HERO}} и Пико пожелали друг другу доброй ночи. За стеклом звёзды продолжали мерцать, а ночная почта больше никуда не спешила.`,
...
Piko xonadagi oxirgi yorqin chiroqni ham o‘chirdi. «Lyumen»da faqat pol bo‘ylab tungi chiroqlar va oyna yonidagi kichkina oltin mayoq qoldi. {{HERO}} yo‘l-yo‘l sharfli Oyga qarab, Pikoga xayrli tun tiladi va dam olishga ketdi. Oyna ortidagi yulduzlar miltillashda davom etdi, tun pochtasi esa tinchgina joyida turardi.`,
      ...
      'choice-b': {
        ...
        effect: {
          ru: `По выбору {{HERO}} на стекле появилась звёздная птица, и её светящееся крыло показало почте путь к «Люмену».`,
          uz: `{{HERO}} yulduz qushini yasadi va uning yorug‘ qanoti pochtaga «Lyumen» tomon yo‘l ko‘rsatdi.`,
        },
        resolution: {
          ru: `На стекле рядом с {{HERO}} начали появляться звёздочки. Четыре сложились в крыло, ещё три — в хвост. Пико хотел помочь, но одна звезда снова прилипла ему ко лбу. Он так и стоял, пока птица не была готова. Серебряная капсула мигнула и чуть повернула в сторону светящегося рисунка. Значит, она заметила звёздный знак.`,
        ...
        episodeTwo: {
          ru: `Почтовая капсула летела вдоль светящейся птицы, будто та действительно показывала дорогу. На кончике крыла появилась ещё одна звёздочка от {{HERO}}. Пико наконец снял свою звезду со лба и торжественно приклеил её в самый хвост.
...
Пальцы {{HERO}} успели поймать её. Клей на тёплом стекле держался плохо. Тогда они не стали возвращать звёздочку на прежнее место. Для неё нашлось место выше, и у птицы появилось новое перо.
...
От смеха конверт в руках {{HERO}} чуть не упал. Пико поставил рисунок Луны в самую большую рамку, а клубнику — рядом.
...
Пико достал мягкую ленту и предложил повесить новые рисунки под окном. На этот раз он держал ленту двумя руками и очень внимательно следил, чтобы не оказаться внутри узла. Кота, клубнику и Луну закрепили маленькими прищепками рядом с {{HERO}}. Клубника вышла такой большой, что Пико дважды проверил: это точно рисунок, а не ужин.

Снаружи капсула мигнула один раз. Зелёная звезда на птице как будто ответила ей. Пико мигнул своими глазами тоже, но по мнению {{HERO}}, трёх разных миганий для одной ночи уже хватало. Робот согласился и перестал соревноваться с окном.

Почтовая капсула устроилась возле станции. Пико сел на пол рядом с {{HERO}} и посмотрел на птицу.

— Оставим её до утра?

Пико увидел кивок {{HERO}}.

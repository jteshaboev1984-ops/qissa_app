...
const output = [
  ...
  '- [ ] Dialogue, reactions and character traits make the cast feel alive without turning one trait into a repeated gimmick.',
  ...
  '- [ ] The selected branch feels substantial rather than like a shortened/inferior route.',
  '- [ ] Resolution bridge is roughly 30–45 words, creates one visible change, and stops before replaying the consequence.',
  '- [ ] Episode 2 continues after the bridge without replaying the selected action or introducing an unrelated filler problem.',
  '- [ ] Prior memory/state is reflected concretely when available rather than announced abstractly.',
  ...
  '### Release note',
  '',
  'Use `docs/qissa/ai/09_FAMILY_BETA_EDITORIAL_SCORECARD.md` for the 0/1/2 scoring decision. A mechanically valid story can still fail family-beta quality.',
  '',
].join('\n')

...
const installationId = '30d91e38-61ce-4016-b8ee-d0423aed57f5'
const installationAuth = randomBytes(32).toString('hex')
const seriesId = 'audit-luna-v56-b7ddc144-2fe3-489d-b362-0416f95f73c1'
...
if (metadata.source !== 'openai-structured' || episode?.generationSource !== 'openai-structured') {
  throw new Error(`Paid request did not publish provider story: ${paid.text.slice(0, 2200)}`)
}

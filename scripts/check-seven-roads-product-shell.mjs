...
requireText('public shell', shell, 'selectedGallerySeasonData')
...
requireText('public shell', shell, 'seasonRomanNumeral')
requireText('public shell', shell, 'galleryProgressPercent')

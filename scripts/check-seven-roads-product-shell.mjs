...
requireText('public shell', shell, 'Истории, сезоны и иллюстрации твоего пути.')
requireText('public shell', shell, '>Сезоны<')
requireText('public shell', shell, '>Галерея<')
requireText('public shell', shell, 'authoredIllustrationDiscovery.buildGalleryEpisodes')
requireText('public shell', shell, 'Открыто по мере чтения')
requireText('public shell', shell, 'Не открыто')
...
requireText('public shell', shell, 'selectedGallerySeason')
requireText('public shell', shell, 'Галерея сезона')
requireText('public shell', shell, 'Сезон {notice.seasonNumber} готовится')
requireText('public shell', shell, 'Иллюстрация ещё скрыта')
...
requireText('reader', player, 'Вернуться к пути сезона')
...
requireText('Seven Roads App', app, 'requestedEpisodeNumber')

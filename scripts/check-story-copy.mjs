...
const bannedStrings = [
  ...
  ['stale local-only persistence claim RU', 'Пока история хранится только на этом устройстве.'],
  ['stale local-only persistence claim UZ', 'Hozircha hikoya faqat shu qurilmada saqlanadi.'],
  ['stale local-only persistence claim KZ', 'Әзірге оқиға тек осы құрылғыда сақталады.'],

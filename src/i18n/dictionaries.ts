...
export type I18nKey =
  ...
  | 'onboarding.title' | 'onboarding.age' | 'onboarding.language' | 'onboarding.hero' | 'onboarding.world' | 'onboarding.story_mode' | 'onboarding.mood' | 'onboarding.world_hint' | 'onboarding.world_continue'
  ...
  | 'story.world_remembers' | 'story.continue_next_episode' | 'story.next_episode_hint' | 'story.episode_end_title' | 'story.episode_end_body' | 'story.back_home' | 'story.confirm_choice' | 'story.narrative_title'
  | 'story.preview_helper' | 'story.show_words' | 'story.hide_words' | 'story.return_home' | 'story.choice_saved_title' | 'story.opening_next_episode' | 'story.end_state_title' | 'story.end_state_body'
  | 'home.world_remembers' | 'home.last_episode_summary' | 'home.reset_story' | 'home.restart_story' | 'home.story_completed_title' | 'home.story_completed_body' | 'home.reopen_story'
  | 'home.show_details' | 'home.hide_details' | 'home.edit_setup' | 'home.start_one_time' | 'home.start_new_story' | 'home.reset_story_soft' | 'home.one_time_in_progress' | 'home.one_time_completed_body'
...
'onboarding.title':'Быстрый старт','onboarding.age':'Для какого возраста сказка?','onboarding.language':'На каком языке рассказать сказку?','onboarding.hero':'Кто будет главным героем?','onboarding.world':'Где начнётся история?','onboarding.story_mode':'Какой формат сказки выбрать?','onboarding.mood':'Какую сказку создать?','onboarding.world_hint':'Выберите мир и продолжите.','onboarding.world_continue':'Выбрать этот мир',
...
'story.read_mode':'Читать','story.listen_mode':'Слушать','story.listen_placeholder':'Здесь будет спокойное прослушивание с обложкой эпизода и управлением аудио.','story.audio_controls':'Управление аудио','story.make_choice':'Что выберет герой?','story.words_preview':'Слова из истории (по желанию)','story.choice_confirmation':'Выбор принят.','story.world_remembers':'История запомнила ваш выбор.','story.continue_next_episode':'Продолжить следующую серию','story.next_episode_hint':'Следующая серия начнётся с этого.','story.episode_end_title':'Финал демо-эпизода','story.episode_end_body':'Спасибо, что дочитали. Можно вернуться домой и начать новую историю.','story.back_home':'Домой','story.confirm_choice':'Подтвердить выбор','story.narrative_title':'Сказка','story.preview_helper':'Выберите вариант и посмотрите, как изменится путь.','story.show_words':'Показать слова из сказки','story.hide_words':'Скрыть слова','story.return_home':'Вернуться домой','story.choice_saved_title':'История запомнила ваш выбор.','story.opening_next_episode':'Открываем следующую серию…','story.end_state_title':'Спокойный финал демо','story.end_state_body':'Спасибо за чтение. Можно вернуться домой и начать новую историю.','home.world_remembers':'История помнит ваш выбор.','home.last_episode_summary':'Чем закончилась последняя серия','home.reset_story':'Сбросить историю','home.restart_story':'Если хотите, можно начать историю заново','home.story_completed_title':'Демо-история завершена','home.story_completed_body':'Вы можете открыть историю снова или начать новую с нуля.','home.reopen_story':'Открыть текущую историю','home.show_details':'Показать детали','home.hide_details':'Скрыть детали','home.edit_setup':'Изменить настройки','home.start_one_time':'Начать отдельную сказку','home.start_new_story':'Начать новую сказку','home.reset_story_soft':'Сбросить только прогресс истории','home.one_time_in_progress':'Это отдельная сказка — можно спокойно продолжить.','home.one_time_completed_body':'Эта отдельная сказка завершена. Можно начать новую.',
}
...
'story.read_mode':'O‘qish','story.listen_mode':'Tinglash','story.listen_placeholder':'Bu yerda epizod muqovasi va audio boshqaruvi ko‘rinadi.','story.audio_controls':'Audio boshqaruvi','story.make_choice':'Qahramon nimani tanlaydi?','story.words_preview':'Hikoyadagi so‘zlar (ixtiyoriy)','story.choice_confirmation':'Tanlov qabul qilindi.','story.world_remembers':'Hikoya olami tanlovingizni eslab qoldi.','story.continue_next_episode':'Keyingi qismga o‘tish','story.next_episode_hint':'Keyingi qism shu tanlovdan boshlanadi.','story.episode_end_title':'Hikoya davom etadi.','story.episode_end_body':'Hikoya olami bu qismda nima bo‘lganini eslab qoladi.','story.back_home':'Bosh sahifaga qaytish','story.confirm_choice':'Tanlovni tasdiqlash','story.narrative_title':'Ertak sahifasi','home.world_remembers':'Hikoya olami tanlovingizni eslaydi.','home.last_episode_summary':'Oxirgi qism yakuni','home.reset_story':'Hikoyani qayta boshlash','home.restart_story':'Istasangiz, hikoyani boshidan boshlashingiz mumkin','home.story_completed_title':'Demo-hikoya yakunlandi','home.story_completed_body':'Hikoyani yana ochishingiz yoki boshidan boshlashingiz mumkin.','home.reopen_story':'Joriy hikoyani ochish','home.show_details':'Batafsil ko‘rsatish','home.hide_details':'Batafsilni yopish','home.edit_setup':'Sozlamani o‘zgartirish','home.start_one_time':'Alohida ertakni boshlash','home.start_new_story':'Yangi ertakni boshlash','home.reset_story_soft':'Faqat hikoya jarayonini tozalash','home.one_time_in_progress':'Bu alohida ertak — xotirjam davom ettiring.','home.one_time_completed_body':'Bu alohida ertak yakunlandi. Yangisini boshlashingiz mumkin.','story.preview_helper':'Variantni tanlab, yo‘lini avval ko‘rib oling.','story.show_words':'Ertakdagi so‘zlarni ko‘rsatish','story.hide_words':'So‘zlarni yashirish','story.return_home':'Bosh sahifaga qaytish','story.choice_saved_title':'Hikoya tanlovingizni eslab qoldi.','story.opening_next_episode':'Keyingi qism ochilmoqda…','story.end_state_title':'Demoning muloyim yakuni','story.end_state_body':'O‘qiganingiz uchun rahmat. Bosh sahifaga qaytib yangi hikoya boshlashingiz mumkin.','onboarding.world_hint':'Bir olamni tanlang va davom eting.','onboarding.world_continue':'Shu olamni tanlash' }
...
'story.read_mode':'Оқу','story.listen_mode':'Тыңдау','story.listen_placeholder':'Мұнда эпизод мұқабасы мен аудио басқару көрсетіледі.','story.audio_controls':'Аудио басқару','story.make_choice':'Кейіпкер нені таңдайды?','story.words_preview':'Оқиға сөздері (қалау бойынша)','story.choice_confirmation':'Таңдау қабылданды.','story.world_remembers':'Оқиға әлемі таңдауыңызды ұмытпайды.','story.continue_next_episode':'Келесі бөлімге өту','story.next_episode_hint':'Келесі бөлім осы таңдаудан басталады.','story.episode_end_title':'Оқиға жалғасады.','story.episode_end_body':'Оқиға әлемі бұл бөлімде не болғанын есте сақтайды.','story.back_home':'Басты бетке қайту','story.confirm_choice':'Таңдауды растау','story.narrative_title':'Ертегі беті','home.world_remembers':'Оқиға әлемі таңдауыңызды есте сақтайды.','home.last_episode_summary':'Соңғы бөлімнің қорытындысы','home.reset_story':'Оқиғаны қайта бастау','home.restart_story':'Қаласаңыз, оқиғаны басынан бастауға болады','home.story_completed_title':'Демо-оқиға аяқталды','home.story_completed_body':'Оқиғаны қайта ашуға немесе басынан бастауға болады.','home.reopen_story':'Ағымдағы оқиғаны ашу','home.show_details':'Толығын көру','home.hide_details':'Толығын жасыру','home.edit_setup':'Баптауды өзгерту','home.start_one_time':'Жеке ертегіні бастау','home.start_new_story':'Жаңа ертегі бастау','home.reset_story_soft':'Тек ертегі барысын тазалау','home.one_time_in_progress':'Бұл жеке ертегі — сабырмен жалғастырыңыз.','home.one_time_completed_body':'Бұл жеке ертегі аяқталды. Жаңасын бастауға болады.','story.preview_helper':'Нұсқаны таңдап, бағытын алдын ала көріңіз.','story.show_words':'Ертегідегі сөздерді көрсету','story.hide_words':'Сөздерді жасыру','story.return_home':'Басты бетке оралу','story.choice_saved_title':'Оқиға таңдауыңызды сақтады.','story.opening_next_episode':'Келесі бөлім ашылып жатыр…','story.end_state_title':'Демоның жайлы финалы','story.end_state_body':'Оқығаныңызға рақмет. Басты бетке оралып, жаңа ертегі бастауға болады.','onboarding.world_hint':'Әлемді таңдап, жалғастырыңыз.','onboarding.world_continue':'Осы әлемді таңдау' }

...
requireCondition(
  /useDeviceNarration/.test(listeningScene) && /speechSynthesis/.test(narrationHook) && /SpeechSynthesisUtterance/.test(narrationHook),
...
requireCondition(
  /ru:\s*\{/.test(listeningScene) && /uz:\s*\{/.test(listeningScene) && /kz:\s*\{/.test(listeningScene),

...
const copy: Record<Language, {
  ...
  ru: {
    ...
    body: 'QISSA сохраняет только данные, необходимые для профиля, продолжения историй и удобного прослушивания.',
    stored: 'Сохраняются возрастная группа, язык, герой, истории, выборы, настройки чтения и позиция прослушивания. Минимальные технические события не содержат текст сказки.',
    ...
    deleteBody: 'Будут навсегда удалены профиль, истории, выборы, настройки, прогресс прослушивания, связанные аудиофайлы и технические события этого профиля/устройства.',
    deleteButton: 'Удалить все данные',
    confirmTitle: 'Подтвердите полное удаление',
    confirmBody: 'Это действие нельзя отменить. Обычный перезапуск истории находится ниже и не удаляет профиль.',
  ...
  uz: {
    ...
    body: 'QISSA faqat profil, hikoyalarni davom ettirish va qulay tinglash uchun zarur ma’lumotlarni saqlaydi.',
    stored: 'Yosh guruhi, til, qahramon, hikoyalar, tanlovlar, o‘qish sozlamalari va tinglash joyi saqlanadi. Minimal texnik hodisalarda hikoya matni bo‘lmaydi.',
    ...
    deleteBody: 'Profil, hikoyalar, tanlovlar, sozlamalar, tinglash jarayoni, bog‘liq audio fayllar va shu profil/qurilmaga tegishli texnik hodisalar butunlay o‘chiriladi.',
    deleteButton: 'Barcha ma’lumotlarni o‘chirish',
    confirmTitle: 'To‘liq o‘chirishni tasdiqlang',
    confirmBody: 'Bu amalni bekor qilib bo‘lmaydi. Oddiy hikoyani qayta boshlash tugmasi pastda va profilni o‘chirmaydi.',
  ...
  kz: {
    ...
    body: 'QISSA профильге, оқиғаны жалғастыруға және ыңғайлы тыңдауға қажет деректерді ғана сақтайды.',
    stored: 'Жас тобы, тіл, кейіпкер, оқиғалар, таңдаулар, оқу баптаулары және тыңдау орны сақталады. Минималды техникалық оқиғаларда оқиға мәтіні болмайды.',
    ...
    deleteBody: 'Профиль, оқиғалар, таңдаулар, баптаулар, тыңдау барысы, байланысты аудиофайлдар және осы профиль/құрылғыға қатысты техникалық оқиғалар біржола жойылады.',

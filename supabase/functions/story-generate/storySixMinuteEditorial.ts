...
Нура показала {{HERO}} старую плетёную сумку. В ней лежали бумажные фонарики. Рядом над папоротником кружились светлячки. Они вспыхивали по очереди, будто кто-то тихонько нажимал невидимые кнопки.

{{HERO}} предложил сначала пройти до самой развилки. По дороге компания заметила лужу в форме луны, поваленную веточку и три блестящих жёлудя. Пух хотел положить один в карман, но промахнулся и уронил его себе в капюшон. Пока он пытался достать желудь, даже черепаха успела его обогнать.
...
{{HERO}} присел рядом с Пухом.

— Как поведём всех домой?

Нура поставила сумку с фонариками на пень. Пух приготовился петь, хотя заранее предупредил, что знает всего три ноты. Белка прижала корзинку к животу, чтобы орехи больше не разбегались. Даже черепаха подняла голову. Теперь выбор был за {{HERO}}.`,
...
Nura chiroqlar solingan xaltani to‘nka ustiga qo‘ydi. Puf esa kuylashga tayyorlandi, lekin oldindan uchta notadan boshqasini bilmasligini aytdi. Olmaxon yong‘oqlari yana qochib ketmasin deb savatini qorniga bosdi. Toshbaqa ham boshini ko‘tardi. Endi tanlov {{HERO}}da edi.`,
    ...
    vocabulary: [
      { word: `развилка`, translation: `fork in the road`, example: `У развилки {{HERO}} остановился рядом с друзьями.` },
      { word: `шелест`, translation: `rustle`, example: `{{HERO}} услышал шелест мокрых листьев.` },
    ],
    choices: {
      'choice-a': {
        text: {
        ...
        effect: {
          ru: `{{HERO}} зажёг фонарики, и у друзей появилась золотая дорожка домой.`,
          uz: `{{HERO}} chiroqlarni yoqdi va do‘stlar uchun uyga boradigan oltinrang yo‘l paydo bo‘ldi.`,
        },
        resolution: {
          ru: `{{HERO}} зажёг первый бумажный фонарик. Из него вдруг вылетел сонный мотылёк и так громко чихнул, что Пух прыснул от смеха. Второй фонарик повесили у лужи-луны, третий — возле берёзы. Нура подняла один повыше, чтобы его было видно издалека. Получилась золотая цепочка, и вся компания двинулась к домикам. Первое тёплое окно уже светилось между ветками.`,
          uz: `{{HERO}} birinchi qog‘oz chiroqni yoqdi. Ichidan uyqusi kelgan kapalak uchib chiqib, shunaqa baland aksirdi-ki, Puf kulib yubordi. Ikkinchi chiroq oy shaklidagi ko‘lmak yoniga, uchinchisi qayin oldiga osildi. Nura bittasini balandroq shoxga qo‘ydi. Yo‘l bo‘ylab oltinrang chiroqlar paydo bo‘ldi va do‘stlar shu nur ortidan uylar tomon yo‘l oldi. Puf kapalak yana aksiradimi, deb chiroqqa qarab qo‘ydi.`,
        },
        seed: {
...
Пух важно передал ей корзинку. Но в этот момент один орех всё-таки выскочил и покатился вниз по корню. {{HERO}} поймал его носком ботинка, а белка решила, что на сегодня корзинке хватит приключений. Фонарик над корнями осветил дорожку к дуплу. Белка помахала всем хвостом и скрылась внутри. Через секунду из окна высунулась только её лапка, чтобы ещё раз помахать.

Дальше тропинка повернула к ручью. Один фонарик качнулся от ветра и развернулся бумажной спинкой к дороге. На земле сразу стало темнее. {{HERO}} уже потянулся поправить его, но Пух заметил золотое отражение в воде.

— Смотрите! Фонарик всё равно показывает нам путь, только снизу!
...
Перед холмом тропинка прошла мимо старой коряги. Фонарик бросил на неё длинную тень, и Пух ахнул: на земле появился огромный ушастый зверь. Он спрятался за {{HERO}}, но через секунду понял, что это его собственные уши. Пух встал боком, тень стала ещё смешнее, и даже Нура тихо хихикнула. Потом они пошли дальше.
...
Теперь можно было идти обратно. {{HERO}} и Нура гасили фонарики один за другим. Там, где исчезал золотой круг, оставались луна, мокрые листья и знакомая тропа. Мотылёк из первого фонаря уже спал на внутренней бумажной стенке, поэтому его не стали тревожить и оставили этот фонарь светиться ещё немного.
...
Daraxtlar orasidagi oxirgi deraza ham o‘chdi. Ariq shivirlab oqardi, kapalak boshqa aksirmadi, bitta chiroq esa kichkina iliq yulduzga o‘xshab qoldi. {{HERO}} Nuraga xayrli tun tiladi. Keyin chiroq ham xiralashdi va Shinam o‘rmon dumaloq oy ostida uxlab qoldi. Uzoqda Puf yalpiz hidli inida allaqachon mizg‘ib qolgan bo‘lsa kerak, to‘nka chetidagi yong‘oq esa tonggacha jim kutardi.`,
      ...
      'choice-b': {
        ...
        effect: {
          ru: `{{HERO}} придумал песенку, и знакомые звуки стали вести друзей по тропинке.`,
          uz: `{{HERO}} kichkina qo‘shiq o‘ylab topdi va tanish tovushlar do‘stlarni yo‘l bo‘ylab boshlab bordi.`,
        },
        resolution: {
          ru: `{{HERO}} хлопнул ладонями простой ритм: раз, два, пауза. Нура ответила двумя короткими нотами. Пух набрал воздуха и выдал такое тоненькое «пи-и», что сам удивился и рассмеялся. Светлячки замигали в такт. Белка добавила деревянный стук двух орехов. Через минуту вся компания знала маленький припев, и у тропинки появилась собственная дорожная песенка.`,
          uz: `{{HERO}} kaftini urib oddiy ritm boshladi: bir, ikki, tanaffus. Nura ikki qisqa nota bilan javob berdi. Puf chuqur nafas olib, shunaqa ingichka «pi-i» dedi-ki, o‘zi ham kulib yubordi. Yorug‘qo‘ng‘izlar ritmga mos miltilladi. Olmaxon ikki yong‘oqni bir-biriga urib «toq-toq» qo‘shdi. Bir daqiqada hamma kichkina yo‘l qo‘shig‘ini yodlab oldi. Puf endi bu kuy yo‘l bo‘ylab o‘zgarishini bilmoqchi edi.`,
        },
        seed: {
...
Чуть дальше был ручей. Здесь вода добавила своё «ш-ш-ш». Нура спела начало, Пух ответил, а {{HERO}} закончил строчку. Светлячки летели над головами и мигали ровно в тот момент, когда наступала пауза.

— У нашей песни уже есть берёза и ручей, — сказал Пух. — Скоро в ней будет весь лес!
...
Так Пух остался с компанией ещё на один кусочек пути. У большого камня песня вдруг стала тише: светлячки разлетелись в разные стороны. {{HERO}} прислушался и услышал, как из травы отвечает один-единственный «пи». Маленький светлячок отстал от остальных и сел на мокрый лист.
...
Перед самым ручьём песня отозвалась из дупла старого дерева. Пух спел «пи», а дупло ответило ему почти таким же «пи-и». Он попробовал ещё раз, теперь ниже. Эхо ответило ниже. Пух попробовал совсем шёпотом, и дерево тоже прошептало в ответ. Пух решил, что там, наверное, живёт невидимый певец. Нура объяснять ничего не стала и только подмигнула {{HERO}}.
...
На обратном пути никто уже не пел весь припев. У берёзы Нура напела две ноты. У ручья {{HERO}} тихо ответил ещё одной. Белкино «тук-тук» донеслось из далёкого окна. Этого хватало, чтобы вспомнить всю дорогу.
...
Eski to‘nka oldida Puf nihoyat xayrlashdi. U iniga qarab uch qadam yugurdi, keyin charchaganini eslab, oddiy yurishga o‘tdi. Nura jilmaydi. Yorug‘qo‘ng‘izlar maysa orasiga qo‘ndi, ariq qo‘shiqning o‘z qismini davom ettirdi, o‘rmon esa asta-sekin tungi tovushlar bilan qoldi. Uzoqdagi in eshigi yopildi. So‘ng faqat barglarning shitiri va suvning «sh-sh-sh»i eshitilib turdi.`,
  ...
  magic_garden: {
    ...
    episodeOne: {
      ru: `В Волшебном саду вечер начинался с одного и того же чуда: как только над фонтаном появлялась первая звезда, лунные цветы открывали серебряные лепестки. {{HERO}} любил смотреть, как они просыпаются. Рядом ползла улитка Мирай, а на ручке маленькой лейки сидела птица Лило.
...
{{HERO}} рассмеялся и осторожно снял лепесток.
...
{{HERO}} прошёл вдоль клумбы. Один бутон стоял у сухого камня. Другой повернулся к отражению звезды в воде. Третий едва заметно дрогнул, когда светлячок подлетел ближе к стеклу.
...
Лило засмеялась так звонко, что один закрытый цветок чуть-чуть качнулся. {{HERO}} заметил это и присел рядом. Похоже, цветы реагировали на всё вокруг: на воду, свет, звук, даже на движение теней.
...
У самого маленького цветка {{HERO}} заметил тонкую серебряную полоску на бутоне. Она то появлялась, то исчезала. Будто цветок хотел открыться, но никак не решался.
...
{{HERO}} опустился на колени у маленького бутона.

— С чего начнём?

Лило перестала считать. Мирай подняла усики. Даже светлячки внутри чаши на секунду собрались в ровный круг. Выбор ждал {{HERO}}.`,
...
Lilo sanashni to‘xtatdi. Miroy mo‘ylovlarini ko‘tardi. Yorug‘qo‘ng‘izlar ham bir lahza dumaloq shaklga tizildi. Tanlov {{HERO}}da edi.`,
    ...
    vocabulary: [
      { word: `лепесток`, translation: `petal`, example: `{{HERO}} увидел серебряный лепесток у фонтана.` },
    ...
    choices: {
      'choice-a': {
        ...
        effect: {
          ru: `{{HERO}} полил сухие корни, и первый лунный цветок раскрыл серебряный лепесток.`,
          uz: `{{HERO}} quruq ildizlarga suv quydi va birinchi oy guli kumushrang gulbargini ochdi.`,
        },
        resolution: {
          ru: `{{HERO}} взял лейку и полил землю вокруг самого маленького бутона. Вода ушла под корни, а через секунду на стебле появилась блестящая капля. Она поднялась выше, словно маленькая бусинка, и бутон раскрыл один серебряный лепесток. Мирай захлопала усиками по раковине, а Лило объявила, что это был «цветочный привет». Теперь они пошли к следующему сухому месту.`,
          uz: `{{HERO}} sug‘orgichni olib, eng kichik g‘uncha atrofidagi tuproqqa suv quydi. Suv ildizlar orasiga singdi. Bir ozdan keyin poyada yaltiragan tomchi paydo bo‘lib, tepaga ko‘tarildi. G‘uncha bitta kumush gulbargini ochdi. Miroy xursand bo‘lib qobig‘ini taqillatdi, Lilo esa buni «gulning salomi» deb e’lon qildi. Endi ular keyingi quruq joy tomon yurdi. Lilo esa keyingi gulga uchib, qaysi tomonda tuproq quruqroq ekanini ko‘rsatdi.`,
        },
        seed: {
        ...
        episodeTwo: {
          ru: `Следующий бутон рос у самого фонтана. Земля вокруг него была тёмной, но под широким листом прятался сухой круг. {{HERO}} подвинул лист и налил туда совсем немного воды.
...
Друзья пошли дальше вдоль клумбы. {{HERO}} поливал только там, где земля была сухой. Иногда цветок открывался сразу, иногда приходилось подождать. Один крошечный бутон вообще не двинулся. Мирай уже хотела проверить корни ещё раз, но Лило заметила, что на его лепестке лежит тяжёлая капля росы.

{{HERO}} коснулся листа рядом. Капля скатилась вниз. Бутон расправился и оказался ярко-голубым внутри.
...
Когда {{HERO}} подошёл ближе, цветок чуть наклонился. Из его середины выкатилась круглая капля и плюхнулась в воду. По фонтану разошлись кольца, и в каждом на секунду отразилась звезда.
...
{{HERO}} набрал в ладонь немного воды и полил последний маленький сухой участок у дорожки. Там не было цветка, зато через минуту из земли показался тонкий зелёный росток.

— О, — сказала Лило. — Похоже, завтра нас кто-то удивит.

Никто не стал будить росток вопросами. {{HERO}} поставил лейку возле фонтана. Лунные цветы один за другим начали складывать лепестки. Голубые точки становились всё бледнее, пока дорожка не превратилась в обычную полоску между клумбами.

Лило спрятала голову под крыло. Мирай зевнула так широко, как умеют зевать только улитки. Фонтан плеснул ещё раз. {{HERO}} посмотрел на маленький зелёный росток, пожелал саду доброй ночи и ушёл по дорожке домой. За спиной серебряные лепестки закрылись окончательно, а на раковине Мирай осталась одна крошечная капля, похожая на звезду.`,
...
Lilo boshini qanoti ostiga oldi. Miroy katta esnadi. Favvora yana bir marta «plop» dedi. {{HERO}} yashil niholga qarab, bog‘ga xayrli tun tiladi va uyiga ketdi. Orqada kumush gulbarglar butunlay yopildi. Miroyning qobig‘ida esa tonggacha saqlanadigandek bitta kichkina tomchi yulduzcha bo‘lib yaltirab qoldi. Lilo qanoti ostidan bir marta ko‘z tashlab, yana uxlab qoldi.`,
      ...
      'choice-b': {
        ...
        effect: {
          ru: `{{HERO}} выпустил светлячков, и их танец помог лунным цветам повернуться к свету.`,
          uz: `{{HERO}} yorug‘qo‘ng‘izlarni uchirdi va ularning raqsi oy gullariga nur tomonga burilishga yordam berdi.`,
        },
        resolution: {
          ru: `{{HERO}} поставил чашу возле закрытых цветов и приподнял крышку. Светлячки вылетели по одному. Первый сделал круг, второй завис над дорожкой, третий сел Лило прямо на макушку. Птица замерла, боясь его спугнуть, и стала похожа на маленькую лампу. Цветок рядом повернулся к огоньку и раскрыл два лепестка. Тогда светлячки полетели дальше вдоль клумбы.`,
          uz: `{{HERO}} shisha kosani yopiq gullar yoniga qo‘yib, qopqog‘ini ochdi. Yorug‘qo‘ng‘izlar bittadan uchib chiqdi. Birinchisi doira chizdi, ikkinchisi yo‘l ustida turdi, uchinchisi esa Lilo boshiga qo‘ndi. Lilo uni qo‘rqitib yubormaslik uchun qimirlamay qoldi va kichkina chiroqqa o‘xshab ketdi. Yonidagi gul og‘irlik bilan nur tomonga burilib, ikki gulbargini ochdi. Qolgan og‘onaklar ham uning ortidan uchib, gulzor bo‘ylab yorug‘ yo‘l boshlab berdi.`,
        },
        seed: {
...
Мирай проползла по краю дорожки и оставила за собой тонкую блестящую линию. Светлячки заметили её и выстроились вдоль следа. Получилась целая светящаяся змейка. {{HERO}} пошёл за ней, а лунные цветы по обе стороны стали открываться один за другим.

Один маленький бутон упорно смотрел в другую сторону. Светлячки кружили перед ним, но он не двигался. Тогда {{HERO}} увидел причину: его стебелёк зацепился за сухую травинку.

{{HERO}} осторожно освободил стебель. Бутон тут же повернулся и раскрылся так быстро, что светлячок на голове Лило от неожиданности взлетел.

— Моя корона! — пискнула Лило и тут же засмеялась.
...
{{HERO}} остановился. Через секунду один светлячок вспыхнул. Потом второй. Потом все остальные разом. Они просто устроили короткую игру в прятки. Лило возмущённо покачала головой, а Мирай смеялась так, что её усики дрожали.
...
— Кажется, он нашёл друга, который всё повторяет, — сказала {{HERO}}.
...
{{HERO}} сел на край фонтана. Мирай спрятала голову в раковину, потом высунулась обратно, потому что забыла пожелать всем доброй ночи. Лило устроилась рядом и прикрыла глаза.

Один за другим цветы начали закрываться. Светлячки тоже гасили огоньки: сначала ярко, потом чуть слабее, потом совсем маленькими искрами. Последний огонёк мигнул {{HERO}} у дорожки. Фонтан отразил его и отпустил.

Сад снова стал тёмным, но теперь в темноте легко угадывались знакомые клумбы. Где-то под листом ещё раз смешно фыркнула Мирай. {{HERO}} пожелал Лило, Мирай и лунным цветам доброй ночи и пошёл домой. Последний светлячок устроился на листе рядом с чашей, словно тоже нашёл себе кроватку, и больше в саду никто никуда не летел.`,
...
Uchib ketgan og‘onak do‘stlariga qo‘shildi. Endi ular yo‘l ustida katta yorug‘ spiral yasadi. Yuqoridan u Miroyning qobig‘iga o‘xshardi.
...
Miroy kosa yoniga kichkina yaproq qo‘yib, yorug‘qo‘ng‘izlar ham dam olishi uchun «yostiq» tayyorladi. Lilo bu yostiq ularga juda katta ekanini aytdi. Bir og‘onak darrov yaproq ustiga qo‘nib, go‘yo aksini isbotlagandek qimirlamay qoldi.
...
Oxirgi og‘onak yo‘l chetida {{HERO}}ga bir marta miltilladi. Favvora uning aksini bir lahza ushlab, keyin qorong‘iga qaytardi. Bog‘ yana qorong‘i bo‘ldi, ammo endi gulzorlarning qayerdaligi bilinib turardi. {{HERO}} Lilo, Miroy va oy gullariga xayrli tun tilab, uyiga ketdi. Kosaning yonidagi bitta yorug‘qo‘ng‘iz yaproq «yostiq» ustiga qo‘ndi va shu yerda qimirlamay qoldi. Bog‘ ham unga qo‘shilib dam olayotgandek edi.`,
  ...
  stars_and_space: {
    ...
    episodeOne: {
      ru: `Ночью станция «Люмен» была похожа на дом с очень большим круглым окном. За стеклом висели звёзды, а внутри горели только маленькие лампы у пола. {{HERO}} помогал роботу Пико готовить место для ночной почты.
...
{{HERO}} подошёл к окну. Далеко в темноте снова мигнула крошечная серебряная точка.

— Она нас ищет, — сказал Пико. — Обычно у нашего окна горит золотой маяк. Сегодня лампа не включилась.

Пико открыл ящик с запасными вещами. В ящике лежали моток мягкой ленты, круглый золотой фонарь и лист светящихся звёздочек. Пико сначала вытащил ленту, запутался в ней одной рукой и попросил {{HERO}} спасти его от «очень серьёзного ленточного чудовища». Через минуту лента снова лежала в ящике, а Пико держал фонарь и звёздочки.

Одна звёздочка сразу прилипла Пико ко лбу.

— Теперь я часть неба, — сообщил робот.

{{HERO}} снял звёздочку и приклеил её на край окна. Пико достал ещё несколько. Можно было зажечь золотой фонарь у стекла, чтобы почтовая капсула увидела один яркий огонёк. А можно было сложить из светящихся звёздочек большую птицу, крыло которой показывало бы на «Люмен».
...
{{HERO}} рассмеялся и посмотрел в окно. Почтовая капсула была уже немного ближе. Она летела сама и никуда не пропадала, просто не могла понять, какое из множества огоньков впереди — окно «Люмена».
...
{{HERO}} приложил к стеклу четыре звёздочки. Из них уже получалось маленькое крыло. Пико поставил рядом фонарь, и золотой круг лёг на стекло.

За окном снова мигнула серебряная точка. На этот раз будто прямо им в ответ.

— Ну что, — спросил Пико, — каким знаком позовём нашу ночную почту домой?

{{HERO}} посмотрел на золотой фонарь и на россыпь звёздочек. Выбор был за ним.`,
...
{{HERO}} bir oltin chiroqqa, bir yulduzchalarga qaradi. Tanlov unda edi.`,
    ...
    vocabulary: [
      { word: `созвездие`, translation: `constellation`, example: `{{HERO}} сложил на окне простое созвездие.` },
    ...
    choices: {
      'choice-a': {
        ...
        effect: {
          ru: `{{HERO}} зажёг золотой маяк, и ночная почта увидела окно «Люмена».`,
          uz: `{{HERO}} oltin chiroqni yoqdi va tun pochtasi «Lyumen» oynasini ko‘rdi.`,
        },
        resolution: {
          ru: `{{HERO}} поставил золотой фонарь у круглого окна и повернул его к серебряной точке. Свет лёг на стекло большим тёплым кругом. Пико выключил соседнюю лампу, чтобы знак было видно лучше. Капсула мигнула один раз, потом ещё два, и стала двигаться прямо к золотому огоньку. Пико довольно кивнул: ночная почта увидела «Люмен».`,
          uz: `{{HERO}} oltin chiroqni dumaloq oyna yoniga qo‘yib, nurni kumush nuqta tomonga burdi. Oynada katta iliq doira paydo bo‘ldi. Piko yonidagi boshqa chiroqni o‘chirdi, shunda oltin belgi yanada aniq ko‘rindi. Kapsula bir marta, keyin yana ikki marta miltilladi va shu nur tomon burildi. Piko xursand bosh irg‘adi: tun pochtasi «Lyumen»ni ko‘rdi.`,
        },
        seed: {
        ...
        episodeTwo: {
          ru: `Почтовая капсула становилась всё больше. Сначала она была как серебряная бусинка, потом — как маленькое яблоко, а потом {{HERO}} уже различил круглое окошко на её боку.

Пико стоял рядом с золотым фонарём и считал мигания.

— Один, два… один, два. Она отвечает нам.
...
Пико посмотрел на {{HERO}}.

— Фонарь всё ещё здесь. Может, покажем его с другого окна?

Они взяли фонарь вдвоём и перенесли к соседнему круглому стеклу. {{HERO}} поднял его повыше. Золотой круг снова появился в темноте, уже сбоку от блестящего облачка.
...
{{HERO}} поставил рисунки в пустые рамки. Пико хотел выбрать самый смешной, но долго не мог решить между котом и Луной. В конце концов он поставил их рядом.

В последнем конверте лежала маленькая бумажная звезда. На ней не было написано ничего важного, только нарисованы четыре точки и улыбка. {{HERO}} прикрепил её возле золотого фонаря.
...
Серебряная капсула снаружи мигнула один раз. {{HERO}} помахал ей через стекло. Пико тоже помахал, но слишком широко и задел локтем пустую коробку. Коробка медленно перевернулась, а робот сделал вид, будто именно так и было задумано.
...
Снаружи серебряная капсула отдыхала возле станции. Облако блёсток уплыло дальше. В большом окне отражались рисунки, Пико и {{HERO}}, а рядом светилась бумажная звезда.

Пико выключил последнюю яркую лампу. На «Люмене» остался только ночной свет у пола и маленький золотой маяк у окна. {{HERO}} посмотрел на Луну в полосатом шарфе, пожелал Пико доброй ночи и отправился отдыхать. За стеклом звёзды продолжали мерцать, а ночная почта больше никуда не спешила.`,
...
Piko oltin chiroq yonida turib, miltillashlarni sanardi.
...
Piko xonadagi oxirgi yorqin chiroqni ham o‘chirdi. «Lyumen»da faqat pol bo‘ylab tungi chiroqlar va oyna yonidagi kichkina oltin mayoq qoldi. {{HERO}} yo‘l-yo‘l sharfli Oyga qarab, Pikoga xayrli tun tiladi va dam olishga ketdi. Oyna ortidagi yulduzlar miltillashda davom etdi, tun pochtasi esa tinchgina joyida turardi.`,
      ...
      'choice-b': {
        ...
        effect: {
          ru: `{{HERO}} сложил звёздную птицу, и её светящееся крыло показало почте путь к «Люмену».`,
          uz: `{{HERO}} yulduz qushini yasadi va uning yorug‘ qanoti pochtaga «Lyumen» tomon yo‘l ko‘rsatdi.`,
        },
        resolution: {
          ru: `{{HERO}} начал приклеивать звёздочки к стеклу. Четыре сложились в крыло, ещё три — в хвост. Пико хотел помочь, но одна звезда снова прилипла ему ко лбу. Он так и стоял, пока {{HERO}} не закончил птицу. Серебряная капсула мигнула и чуть повернула в сторону светящегося рисунка. Значит, она заметила звёздный знак.`,
          uz: `{{HERO}} oynaga yorug‘ yulduzchalarni yopishtira boshladi. To‘rttasi qanot bo‘ldi, yana uchtasi dumga aylandi. Piko yordam bermoqchi edi, ammo bitta yulduz yana peshonasiga yopishdi. {{HERO}} qushni tugatguncha u shu holatda turdi. Keyin qushning boshiga yana ikkita kichik yulduz qo‘shishdi. Tashqaridagi kumush kapsula miltillab, yorug‘ rasm tomonga burildi. Demak, u yangi yulduz qushini ko‘rib, qaysi tomonga uchishni tushunibdi.`,
        },
        seed: {
        ...
        episodeTwo: {
          ru: `Почтовая капсула летела вдоль светящейся птицы, будто та действительно показывала дорогу. {{HERO}} добавил ещё одну звёздочку на кончик крыла. Пико наконец снял свою звезду со лба и торжественно приклеил её в самый хвост.

— Важная деталь, — сказал он.
...
{{HERO}} поймал её пальцем. Клей на тёплом стекле держался плохо. Тогда они не стали возвращать звёздочку на прежнее место. {{HERO}} передвинул её выше, и у птицы появилось новое перо.
...
{{HERO}} смеялся так, что чуть не уронил конверт. Пико поставил рисунок Луны в самую большую рамку, а клубнику — рядом.

В маленьком кармашке капсулы лежала ещё одна светящаяся звёздочка. Она была зелёной, не золотой. {{HERO}} приклеил её в середину птицы.

Теперь рисунок на окне стал совсем необычным: золотые крылья и зелёное сердечко.

Пико достал мягкую ленту и предложил повесить новые рисунки под окном. На этот раз он держал ленту двумя руками и очень внимательно следил, чтобы не оказаться внутри узла. {{HERO}} прикрепил кота, клубнику и Луну маленькими прищепками. Клубника вышла такой большой, что Пико дважды проверил: это точно рисунок, а не ужин.

Снаружи капсула мигнула один раз. Зелёная звезда на птице как будто ответила ей. Пико мигнул своими глазами тоже, но {{HERO}} сказал, что три разных мигания уже слишком много для одной ночи. Робот согласился и перестал соревноваться с окном.

Почтовая капсула устроилась возле станции. Пико сел на пол рядом с {{HERO}} и посмотрел на птицу.

...
requireText('Seven Roads copy', copy, "consentTitle: 'Ma’lumotlar shu qurilmada saqlanadi'")
requireText('Seven Roads copy', copy, "episodesChoices: '6 qism · 4 tanlov'")
requireText('Seven Roads copy', copy, "progressAndChoices: 'O‘qilgan joy va tanlovlar'")
...
requireText('Seven Roads copy', copy, "nextEpisode: 'Keyingi qismga o‘tish'")
requireText('Seven Roads copy', copy, "finishToday: 'Hozircha to‘xtash'")
requireText('Seven Roads copy', copy, "episodeFinishedBody:")
requireText('Seven Roads copy', copy, "O‘qigan joying saqlandi.")
requireText('Seven Roads copy', copy, "formatSevenRoadsSeasonLabel")
requireText('Seven Roads copy', copy, "formatSevenRoadsEpisodeLabel")
requireText('Seven Roads copy', copy, "formatSevenRoadsEpisodeCompleted")
requireText('Seven Roads copy', copy, "formatSevenRoadsSeasonCompleted")
...
forbidText('Seven Roads copy', copy, "Yo‘lni hozir davom ettirish yoki shu yerda to‘xtash mumkin.")
forbidText('Seven Roads copy', copy, "O‘qish jarayoni allaqachon saqlandi.")
forbidText('Seven Roads copy', copy, "Mavsum yo‘liga qaytish")
forbidText('Seven Roads copy', copy, "O‘tilgan qismlarni qayta ochish mumkin.")
forbidText('Seven Roads copy', copy, "joriy jarayon")
...
requireText('public shell', shell, 'expandedGalleryEpisode')
requireText('public shell', shell, 'setExpandedGalleryEpisode(')
requireText('public shell', shell, 'episodePanelId')
requireText('public shell', shell, 'aria-expanded={episodeExpanded}')
requireText('public shell', shell, "episodeExpanded ? 'rotate-180' : ''")
requireText('public shell', shell, 'setExpandedGalleryEpisode(null)')
...
forbidText('public shell Uzbek number order', shell, '${copy.season} 1')
forbidText('public shell Uzbek completion', shell, 'Mavsum yakunlandi')
...
requireText('season overview Uzbek numbering', overview, 'formatSevenRoadsSeasonLabel(language, season.number)')
requireText('season overview Uzbek numbering', overview, 'formatSevenRoadsEpisodeLabel(language, episode.number)')
forbidText('season overview Uzbek number order', overview, '{copy.season} {season.number}')
forbidText('season overview Uzbek number order', overview, '{copy.episode} {episode.number}')
...
requireText('reader', player, 'formatSevenRoadsEpisodeProgress(language, readerProgress.current, readerProgress.total)')
requireText('reader', player, 'formatSevenRoadsSeasonCompleted(language, seasonNumber)')
...
requireText('reader Uzbek numbering', player, 'formatSevenRoadsSeasonLabel(language, seasonNumber)')
requireText('reader Uzbek numbering', player, 'formatSevenRoadsSeasonLabel(language, seasonNumber + 1)')
requireText('reader Uzbek numbering', player, 'formatSevenRoadsEpisodeCompleted(language, readerProgress.current)')
forbidText('reader Uzbek number order', player, '{copy.season} {seasonNumber}')
forbidText('reader Uzbek number order', player, '{copy.episode} {readerProgress.current}')
forbidText('reader Uzbek completion calque', player, "language === 'uz' ? 'yakunlandi'")

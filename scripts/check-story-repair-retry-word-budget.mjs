...
// Deterministic synthetic v93 failure shape: Narrator underlength, first Repair
...
const candidate = {
  ...
  story_text: Array(249).fill('Momiq').join(' ') + ' {{HERO}}.\n\nMomiq tanlovni kutadi.',
  choices: [
...
const retryFeedback = 'Previous text repair failed deterministic validation: story_too_short. Rejected repair metrics: story_words=292, choice_1_resolution_words=30, choice_2_resolution_words=30.'
...
assert.equal(retry.retry_previous_story_words, 292)
assert.equal(retry.retry_remaining_deficit_words, 28)

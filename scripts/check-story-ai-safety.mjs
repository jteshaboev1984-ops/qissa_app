...
requireText('story prompts', prompts, [
  ...
  'exploration / build-up: about 250-290 words',
  'choice setup: about 60-80 words',
  ...
  'never import hypothetical objects, discoveries, state changes or consequences from an unselected branch',
